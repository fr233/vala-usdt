...
#define FOLLY_SDT_S_NO_STRINGFY(x)                x
#define FOLLY_SDT_ASM_STRING_NO_STRINGFY(x)       FOLLY_SDT_ASM_1(.asciz FOLLY_SDT_S_NO_STRINGFY(x))
...
//#define FOLLY_SDT_ARG_TEMPLATE_0    /*should not appear */
#define FOLLY_SDT_ARG_TEMPLATE_1    /*No arguments (except null)*/
#define FOLLY_SDT_ARG_TEMPLATE_2    FOLLY_SDT_ARGFMT(1)
#define FOLLY_SDT_ARG_TEMPLATE_3    FOLLY_SDT_ARG_TEMPLATE_2 FOLLY_SDT_ARGFMT(2)
#define FOLLY_SDT_ARG_TEMPLATE_4    FOLLY_SDT_ARG_TEMPLATE_3 FOLLY_SDT_ARGFMT(3)
#define FOLLY_SDT_ARG_TEMPLATE_5    FOLLY_SDT_ARG_TEMPLATE_4 FOLLY_SDT_ARGFMT(4)
#define FOLLY_SDT_ARG_TEMPLATE_6    FOLLY_SDT_ARG_TEMPLATE_5 FOLLY_SDT_ARGFMT(5)
#define FOLLY_SDT_ARG_TEMPLATE_7    FOLLY_SDT_ARG_TEMPLATE_6 FOLLY_SDT_ARGFMT(6)
#define FOLLY_SDT_ARG_TEMPLATE_8    FOLLY_SDT_ARG_TEMPLATE_7 FOLLY_SDT_ARGFMT(7)
#define FOLLY_SDT_ARG_TEMPLATE_9    FOLLY_SDT_ARG_TEMPLATE_8 FOLLY_SDT_ARGFMT(8)
#define FOLLY_SDT_ARG_TEMPLATE_10    FOLLY_SDT_ARG_TEMPLATE_9 FOLLY_SDT_ARGFMT(9)

// Semaphore define, declare and probe note format

#define FOLLY_SDT_SEMAPHORE_STR(provider, name) \
  "folly_sdt_semaphore_" provider "_" name
    
#define FOLLY_SDT_DEFINE_SEMAPHORE(provider, name)                             \
    __asm__(                                                                    \
        ".globl	" FOLLY_SDT_SEMAPHORE_STR(provider, name) "\n"                  \
	".section " FOLLY_SDT_SEMAPHORE_SECTION ", \"aw\"" "\n"                \
	".align 2" "\n"                                                         \
	".type " FOLLY_SDT_SEMAPHORE_STR(provider, name) ", @object" "\n"       \
	".size " FOLLY_SDT_SEMAPHORE_STR(provider, name) ", 2" "\n"             \
FOLLY_SDT_SEMAPHORE_STR(provider, name) ": " "\n"                               \
	".zero	2" "\n"                                                         \
	".text " "\n"                                                    \
	)
...
#define FOLLY_SDT_DECLARE_SEMAPHORE(provider, name)                            \
  extern volatile unsigned short FOLLY_SDT_SEMAPHORE(provider, name)

#define FOLLY_SDT_SEMAPHORE_NOTE_0(provider, name)                             \
  FOLLY_SDT_ASM_1(     FOLLY_SDT_ASM_ADDR 0) /*No Semaphore*/                  \

#define FOLLY_SDT_ASM_ADDR_STR ".8byte"

#define FOLLY_SDT_SEMAPHORE_NOTE_1(provider, name)                             \
  FOLLY_SDT_ASM_ADDR_STR " " FOLLY_SDT_SEMAPHORE_STR(provider, name) "\n"
...
#define FOLLY_SDT_NOTE_CONTENT(provider, name, has_semaphore, arg_template)    \
  ...
  FOLLY_SDT_ASM_STRING_NO_STRINGFY(provider)                                               \
  FOLLY_SDT_ASM_STRING_NO_STRINGFY(name)                                                   \
